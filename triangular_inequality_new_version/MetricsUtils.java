...
public class MetricsUtils {
	private float epsylon = 0.15f;
	private float epsylon_doble = epsylon*2f;
    private float epsylon_2_2sqrt = (float) (2*Math.sqrt(2*epsylon));
    private float epsylon_2_2sqrt_short = (float) (epsylon_2_2sqrt*10000f);  
    private float epsylon_cota2_2 = (float) (Math.sqrt((-72f + 24f*Math.sqrt(9f + 2f*epsylon)))*10000f);

    private float epsylon_doble_cota2_2 = (float) (Math.sqrt((-72f + 24f*Math.sqrt(9f + 4f*epsylon)))*10000f);
	
	public MetricsUtils(float epsylon) {
	    epsylon_2_2sqrt = (float) (2*Math.sqrt(2*epsylon));
	    epsylon_2_2sqrt_short = (float) (epsylon_2_2sqrt*10000f);  
	    epsylon_cota2_2 = (float) (Math.sqrt((-72f + 24f*Math.sqrt(9+2*epsylon)))*10000f);
	    epsylon_doble_cota2_2 = (float) (Math.sqrt((-72f + 24f*Math.sqrt(9+4*epsylon)))*10000f);
	    epsylon_doble = epsylon*2f;
	}
	
    private float math_log_2 = (float) Math.log(2f);
     ...
     * @return
     */
    public double distL1(int[] h1, int[] h2) {
        double sum = 0d;
    ...
    public double distL1(double[] h1, double[] h2) {
        double sum = 0d;
        for (int i = 0; i < h1.length; i++) {
            sum += Math.abs(h1[i] - h2[i]);
        }
     ...
     * @return
     */
    public double distL2(int[] h1, int[] h2) {
        double sum = 0d;
        for (int i = 0; i < h1.length; i++) {
     ...
     * @return
     */
    public double distL2(double[] h1, double[] h2) {
        double sum = 0d;
        for (int i = 0; i < h1.length; i++) {
            sum += (h1[i] - h2[i]) * (h1[i] - h2[i]);
        }
     ...
     * @return
     */
    public float distL2(float[] h1, float[] h2) {
        float sum = 0f;
        for (int i = 0; i < h1.length; i++) {
            sum += (h1[i] - h2[i]) * (h1[i] - h2[i]);
        }
     ...
     * @return
     */
    public double jsd(int[] h1, int[] h2) {
        double sum = 0d;
        for (int i = 0; i < h1.length; i++) {
    ...
    public float jsd(float[] h1, float[] h2) {
        float sum = 0f;
        for (int i = 0; i < h1.length; i++) {
    ...
    public float jsd(double[] h1, double[] h2) {
        double sum = 0f;
        for (int i = 0; i < h1.length; i++) {
            sum += (h1[i] > 0 ? (h1[i] / 2f) * Math.log((2f * h1[i]) / (h1[i] + h2[i])) : 0) +
    ...
    public float jsd_tuning1(double[] h1, double[] h2) {
    	// lower bound 1
    	double sum = 0f;
    	for (int i = 0; i < h1.length; i++) {
    ...
    public float jsd_tuning2(short[] h1, short[] h2) {
    	// lower bound 1
    	int sum = 0;
    	for (int i = 0; i < h1.length; i++) {
    	...
    	// 2epsylon matrix, para desigualdad triangular
    	if(sum >= epsylon_doble_cota2_2){
    		return epsylon_doble;
    	}    	
    ...
    public float jsd_bound_epsylon_doble(short[] h1, short[] h2) {
    	// lower bound 1
    	int sum = 0;
    	for (int i = 0; i < h1.length; i++) {
    		int diff = (int)h1[i] -  (int)h2[i];
    ...
    public float jsd_tuning3(short[] h1, short[] h2, float epsylon, float epsylon_2_2sqrt_short) {
    	// lower bound 1
    	int sum = 0;
    	for (int i = 0; i < h1.length; i++) {
    		int diff = h1[i] -  h2[i];
    ...
    public float jsd_tuning4(short[] h1, short[] h2, float[] log_h1, float[] log_h2) {
    	// lower bound 1
    	int sum = 0;
    	for (int i = 0; i < h1.length; i++) {
    		int diff = h1[i] -  h2[i];
    ...
    public float jsd_tuning5(short[] h1, short[] h2, float[] log_h1, float[] log_h2) { 	
    	int sum = 0;
    	for (int i = 0; i < h1.length; i++) {
    		int diff = (int)h1[i] -  (int)h2[i];
    		sum +=  (diff > 0 ? diff : -diff);
...
//    	}
    ...
    public float jsd_tuning6(short[] h1, short[] h2, float[] log_h1, float[] log_h2) { 	
    	int sum = 0;
    	for (int i = 0; i < h1.length; i++) {
    		int diff = (int)h1[i] -  (int)h2[i];
    		sum +=  (diff > 0 ? diff : -diff);   		
    ...
    public double tanimoto(int[] h1, int[] h2) {
        double result = 0;
        double tmp1 = 0;
        double tmp2 = 0;
    ...
    public double tanimoto(float[] h1, float[] h2) {
        double result = 0;
        double tmp1 = 0;
        double tmp2 = 0;
    ...
    public double tanimoto(double[] h1, double[] h2) {
        double result = 0;
        double tmp1 = 0;
        double tmp2 = 0;
    ...
    public double cosineCoefficient(double[] hist1, double[] hist2) {
        double distance = 0;
    ...
    public float distL1(float[] h1, float[] h2) {
        float sum = 0f;
        for (int i = 0; i < h1.length; i++) {
            sum += Math.abs(h1[i] - h2[i]);
        }
    ...
    public double distL1(byte[] h1, byte[] h2) {
        double sum = 0f;
        for (int i = 0; i < h1.length; i++) {
            sum += Math.abs(h1[i] - h2[i]);
        }
	 ...
	 */
	public double computeHellingerDist(double P_mean, double P_variance,double Q_mean,double Q_variance) 
	{
	 ...
	 * @return the entropy for the given class distribution.
	 */
	public double computeHellingerDist(double[][] dist) 
	{
		double negatives=0;
		double positives=0;
